				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('xiaoyuanmeishi','下单')" @click="onAcrossTap('zaixianxiadan')" type="button" class="layui-btn">
								下单
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`xiaoyuanmeishi`);
