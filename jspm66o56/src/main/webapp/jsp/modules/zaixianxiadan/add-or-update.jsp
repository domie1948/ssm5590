		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑在线下单</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑在线下单</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">在线下单信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>菜名</label>
										<input id="caiming" name="caiming" class="form-control" placeholder="菜名">
									</div>
									<div class="form-group col-md-6">
										<label>菜系</label>
									...
									<div class="form-group col-md-6">
										<label>总价</label>
										<input id="zongjia" name="zongjia" class="form-control" placeholder="总价">
									</div>
									<div class="form-group col-md-6">
										<label>时间</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "zaixianxiadan/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("zaixianxiadan/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.caiming != null && res.data.caiming != ''){

					$("#caiming").val(res.data.caiming);
					}
