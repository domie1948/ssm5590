...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">校园美食管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>校园美食管理</span></li>
								<li class="breadcrumb-item active"><span>校园美食列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">校园美食列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shicai')">食材<i id="shicaiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
            ...
            crossBtn1.innerHTML = "下单"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"zaixianxiadan\")");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xiaoyuanmeishi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("xiaoyuanmeishi"+colName,"GET",{
		...
		function caixiSelect(){
			//填充下拉框选项
			http("option/caixileibie/caixi","GET",{},(res)=>{
				if(res.code == 0){
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"xiaoyuanmeishi");
